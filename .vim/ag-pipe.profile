...
count  total (s)   self (s)
    ...
    1              0.000010 if !exists("g:agprg")
    1              0.000008   let g:agprg="ag --column"
    1              0.000003 endif
    ...
    1              0.000009 function! ag#Ag(cmd, args)
...
count  total (s)   self (s)
    1              0.000024   let l:ag_executable = get(split(g:agprg, " "), 0)
                              ...
                              " Ensure that `ag` is installed
    1              0.000042   if !executable(l:ag_executable)
                                echoe "Ag command '" . l:ag_executable . "' was not found. Is the silver searcher installed and on your $PATH?"
                                return
                              endif
    ...
    1              0.000005   try
    1              0.000016     let &grepprg=g:agprg
    1              0.000007     let &grepformat=g:agformat
    1   0.114743   0.062581     silent execute a:cmd . " " . escape(l:grepargs, '|')
    1              0.000007   finally
    1              0.000017     let &grepprg=grepprg_bak
    1              0.000008     let &grepformat=grepformat_bak
    1              0.000005   endtry
                            
    1              0.000013   if a:cmd =~# '^l'
                                let l:match_count = len(getloclist(winnr()))
                              else
    1              0.000399     let l:match_count = len(getqflist())
    1              0.000004   endif
                            
    1              0.000040   if a:cmd =~# '^l' && l:match_count
                                exe g:ag_lhandler
                                let l:apply_mappings = g:ag_apply_lmappings
                                let l:matches_window_prefix = 'l' " we're using the location list
                              elseif l:match_count
    1   0.018675   0.001455     exe g:ag_qhandler
    ...
    1              0.000013   if l:match_count
    1              0.000005     if l:apply_mappings
    1              0.000034       nnoremap <silent> <buffer> h  <C-W><CR><C-w>K
    1              0.000021       nnoremap <silent> <buffer> H  <C-W><CR><C-w>K<C-w>b
    1              0.000014       nnoremap <silent> <buffer> o  <CR>
    1              0.000031       nnoremap <silent> <buffer> t  <C-w><CR><C-w>T
    1              0.000020       nnoremap <silent> <buffer> T  <C-w><CR><C-w>TgT<C-W><C-W>
    1              0.000022       nnoremap <silent> <buffer> v  <C-w><CR><C-w>H<C-W>b<C-W>J<C-W>t
                            
    1              0.000036       exe 'nnoremap <silent> <buffer> e <CR><C-w><C-w>:' . l:matches_window_prefix .'close<CR>'
    1              0.000030       exe 'nnoremap <silent> <buffer> go <CR>:' . l:matches_window_prefix . 'open<CR>'
    1              0.000027       exe 'nnoremap <silent> <buffer> q  :' . l:matches_window_prefix . 'close<CR>'
    ...
    1              0.000066         echom "ag.vim keys: q=quit <cr>/e/t/h/v=enter/edit/tab/split/vsplit go/T/H/gv=preview versions of same"
    1              0.000004       endif
    1              0.000003     endif
    1              0.000003   else
                                echom 'No matches for "'.a:args.'"'
